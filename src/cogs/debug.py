...
class Debug(commands.Cog):
    ...
    @commands.command(description="Run Python code! Supports \`\`\`py formatting too <3")
    ...
    @commands.command(aliases=["abort", "quit"], description="The literal defenition of \"kys\"")
    async def exit(self, ctx):
        await ctx.message.add_reaction("👍")
        os.system("kill 1")

    @commands.command(description="Clears all of your messages in a server :trollface:")
